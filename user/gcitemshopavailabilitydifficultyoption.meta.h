 ...
 */
class cGcItemShopAvailabilityDifficultyOption : cTkMetaData::Registrar<cGcItemShopAvailabilityDifficultyOption>, cTkMetaDataXML::Registrar<cGcItemShopAvailabilityDifficultyOption>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x9E64FF6ABCCC176A,
    };
    enum
    {
        mu64TemplateHash = 0x45E28131CA26A14B,
    };
