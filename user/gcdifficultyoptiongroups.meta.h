 ...
 */
class cGcDifficultyOptionGroups : cTkMetaData::Registrar<cGcDifficultyOptionGroups>, cTkMetaDataXML::Registrar<cGcDifficultyOptionGroups>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x48BADFDDC969F879,
    };
    enum
    {
        mu64TemplateHash = 0x8F65E41AFFAD2F8C,
    };
