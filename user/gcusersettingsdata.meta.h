 ...
 */
class cGcUserSettingsData : cTkMetaData::Registrar<cGcUserSettingsData>, cTkMetaDataXML::Registrar<cGcUserSettingsData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x3A50D683FD1CF4BF,
    };
    enum
    {
        mu64TemplateHash = 0xB1245EFE662ED9AE,
    };
