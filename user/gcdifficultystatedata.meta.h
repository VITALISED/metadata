/**
 * @file gcdifficultystatedata.meta.h
 ...
 */
class cGcDifficultyStateData : cTkMetaData::Registrar<cGcDifficultyStateData>, cTkMetaDataXML::Registrar<cGcDifficultyStateData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x814973F0DDEB62C8,
    };
    enum
    {
        mu64TemplateHash = 0x336C024001BFA1B3,
    };
