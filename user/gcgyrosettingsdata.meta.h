 ...
 */
class cGcGyroSettingsData : cTkMetaData::Registrar<cGcGyroSettingsData>, cTkMetaDataXML::Registrar<cGcGyroSettingsData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x4EA99277E076565E,
    };
    enum
    {
        mu64TemplateHash = 0xDC3376240A715E64,
    };
