 ...
 */
class cGcDifficultySettingEnum : cTkMetaData::Registrar<cGcDifficultySettingEnum>, cTkMetaDataXML::Registrar<cGcDifficultySettingEnum>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x42FEEB238F6504DE,
    };
    enum
    {
        mu64TemplateHash = 0x3697C286B1CD1B33,
    };
