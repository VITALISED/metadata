 ...
 */
class cGcSubstanceCollectionDifficultyOption : cTkMetaData::Registrar<cGcSubstanceCollectionDifficultyOption>, cTkMetaDataXML::Registrar<cGcSubstanceCollectionDifficultyOption>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x685F577065EC8459,
    };
    enum
    {
        mu64TemplateHash = 0x7356FAF37859706E,
    };
