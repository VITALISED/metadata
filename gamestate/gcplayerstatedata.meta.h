 ...
 */
class cGcPlayerStateData : cTkMetaData::Registrar<cGcPlayerStateData>, cTkMetaDataXML::Registrar<cGcPlayerStateData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x6C4510BB243EFA64,
    };
    enum
    {
        mu64TemplateHash = 0x8FEEE8175F5670DD,
    };
