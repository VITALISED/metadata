/**
 * @file gcmaintenancecontainer.meta.h
 ...
 */
class cGcMaintenanceContainer : cTkMetaData::Registrar<cGcMaintenanceContainer>, cTkMetaDataXML::Registrar<cGcMaintenanceContainer>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x4AF1E9D7AD4CC1C7,
    };
    enum
    {
        mu64TemplateHash = 0xEF4B1C508C663D7,
    };
