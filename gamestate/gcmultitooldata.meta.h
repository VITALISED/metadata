 ...
 */
class cGcMultitoolData : cTkMetaData::Registrar<cGcMultitoolData>, cTkMetaDataXML::Registrar<cGcMultitoolData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x2AF78E5732410B4F,
    };
    enum
    {
        mu64TemplateHash = 0x8539583BD5C9621B,
    };
