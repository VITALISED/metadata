 ...
 */
class cGcSeasonalGameModeData : cTkMetaData::Registrar<cGcSeasonalGameModeData>, cTkMetaDataXML::Registrar<cGcSeasonalGameModeData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xFD6B0BE30E218605,
    };
    enum
    {
        mu64TemplateHash = 0xA4C94919ED47AAA7,
    };
