 ...
 */
class cGcInteractionBufferType : cTkMetaData::Registrar<cGcInteractionBufferType>, cTkMetaDataXML::Registrar<cGcInteractionBufferType>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x56096224708D16B,
    };
    enum
    {
        mu64TemplateHash = 0xA7327182011FA2C6,
    };
