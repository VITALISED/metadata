 ...
 */
class cGcBaseBuildingPalette : cTkMetaData::Registrar<cGcBaseBuildingPalette>, cTkMetaDataXML::Registrar<cGcBaseBuildingPalette>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xB499CC97C0515963,
    };
    enum
    {
        mu64TemplateHash = 0xCC9B662A4D061ACE,
    };
