 ...
 */
class cGcBaseBuildingGroup : cTkMetaData::Registrar<cGcBaseBuildingGroup>, cTkMetaDataXML::Registrar<cGcBaseBuildingGroup>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xF37F133693523902,
    };
    enum
    {
        mu64TemplateHash = 0x3441CC565EC3BCC0,
    };
