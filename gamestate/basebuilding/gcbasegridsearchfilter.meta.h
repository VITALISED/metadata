/**
 * @file gcbasegridsearchfilter.meta.h
 ...
 */
class cGcBaseGridSearchFilter : cTkMetaData::Registrar<cGcBaseGridSearchFilter>, cTkMetaDataXML::Registrar<cGcBaseGridSearchFilter>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xA4186DCC6FC21A11,
    };
    enum
    {
        mu64TemplateHash = 0x502237C1EE9366E8,
    };
