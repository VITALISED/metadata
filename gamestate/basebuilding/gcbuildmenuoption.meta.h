 ...
 */
enum eBuildMenuOption : uint32_t
{
 ...
 */
class cGcBuildMenuOption : cTkMetaData::Registrar<cGcBuildMenuOption>, cTkMetaDataXML::Registrar<cGcBuildMenuOption>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xCF846F604521AD4F,
    };
    enum
    {
        mu64TemplateHash = 0x655CD9EAB6B8C9B5,
    };
