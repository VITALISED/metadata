 ...
 */
class cGcBaseBuildingTable : cTkMetaData::Registrar<cGcBaseBuildingTable>, cTkMetaDataXML::Registrar<cGcBaseBuildingTable>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x69B43206529CA591,
    };
    enum
    {
        mu64TemplateHash = 0x699CA7FB32674596,
    };
