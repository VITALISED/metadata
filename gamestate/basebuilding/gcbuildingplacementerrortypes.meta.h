 ...
 */
class cGcBuildingPlacementErrorTypes : cTkMetaData::Registrar<cGcBuildingPlacementErrorTypes>, cTkMetaDataXML::Registrar<cGcBuildingPlacementErrorTypes>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xC2EE53901B0156DE,
    };
    enum
    {
        mu64TemplateHash = 0xBA85C40C7D96F32C,
    };
