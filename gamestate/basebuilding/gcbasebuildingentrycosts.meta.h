 ...
 */
class cGcBaseBuildingEntryCosts : cTkMetaData::Registrar<cGcBaseBuildingEntryCosts>, cTkMetaDataXML::Registrar<cGcBaseBuildingEntryCosts>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x2229006A022A6430,
    };
    enum
    {
        mu64TemplateHash = 0xEE84845AB3262787,
    };
