 ...
 */
class cGcBaseSearchFilter : cTkMetaData::Registrar<cGcBaseSearchFilter>, cTkMetaDataXML::Registrar<cGcBaseSearchFilter>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x53636362EAB448BF,
    };
    enum
    {
        mu64TemplateHash = 0xB3DC3F536A016394,
    };
