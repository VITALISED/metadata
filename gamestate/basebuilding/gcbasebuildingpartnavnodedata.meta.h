 ...
 */
class cGcBaseBuildingPartNavNodeData : cTkMetaData::Registrar<cGcBaseBuildingPartNavNodeData>, cTkMetaDataXML::Registrar<cGcBaseBuildingPartNavNodeData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xAE95337199B47CD,
    };
    enum
    {
        mu64TemplateHash = 0xACE410E33E2B84B0,
    };
