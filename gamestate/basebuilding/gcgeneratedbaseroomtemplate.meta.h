/**
 * @file gcgeneratedbaseroomtemplate.meta.h
 ...
 */
class cGcGeneratedBaseRoomTemplate : cTkMetaData::Registrar<cGcGeneratedBaseRoomTemplate>, cTkMetaDataXML::Registrar<cGcGeneratedBaseRoomTemplate>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x11A53087B029E4F,
    };
    enum
    {
        mu64TemplateHash = 0x3990C837CE0F70A1,
    };
