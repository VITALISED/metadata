/**
 * @file gcseasonpetconstraints.meta.h
 ...
 */
class cGcSeasonPetConstraints : cTkMetaData::Registrar<cGcSeasonPetConstraints>, cTkMetaDataXML::Registrar<cGcSeasonPetConstraints>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x154E67C8939691E0,
    };
    enum
    {
        mu64TemplateHash = 0xFDA422DC68B001D0,
    };
