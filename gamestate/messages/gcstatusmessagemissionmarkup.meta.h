 ...
 */
class cGcStatusMessageMissionMarkup : cTkMetaData::Registrar<cGcStatusMessageMissionMarkup>, cTkMetaDataXML::Registrar<cGcStatusMessageMissionMarkup>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x8E8EC2C807363E97,
    };
    enum
    {
        mu64TemplateHash = 0xBE39D03F2CDE8335,
    };
