 ...
 */
class cGcModSettingsInfo : cTkMetaData::Registrar<cGcModSettingsInfo>, cTkMetaDataXML::Registrar<cGcModSettingsInfo>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xC0CE6220E5E98BD9,
    };
    enum
    {
        mu64TemplateHash = 0xF658C5CC0A4A78DE,
    };
