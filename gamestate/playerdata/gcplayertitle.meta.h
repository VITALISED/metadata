 ...
 */
class cGcPlayerTitle : cTkMetaData::Registrar<cGcPlayerTitle>, cTkMetaDataXML::Registrar<cGcPlayerTitle>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x864FCB26DF972FCF,
    };
    enum
    {
        mu64TemplateHash = 0x5D71BDFA93D8D2C7,
    };
