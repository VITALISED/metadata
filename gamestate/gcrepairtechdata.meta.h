 ...
 */
class cGcRepairTechData : cTkMetaData::Registrar<cGcRepairTechData>, cTkMetaDataXML::Registrar<cGcRepairTechData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xD610CA25729E63C3,
    };
    enum
    {
        mu64TemplateHash = 0xD60BF4F6EBCDA98,
    };
