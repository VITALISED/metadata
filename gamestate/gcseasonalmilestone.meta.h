 ...
 */
class cGcSeasonalMilestone : cTkMetaData::Registrar<cGcSeasonalMilestone>, cTkMetaDataXML::Registrar<cGcSeasonalMilestone>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x4EDC167332F6B824,
    };
    enum
    {
        mu64TemplateHash = 0x5D65FBCDFF91C956,
    };
