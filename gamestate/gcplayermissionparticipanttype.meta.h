 ...
 */
class cGcPlayerMissionParticipantType : cTkMetaData::Registrar<cGcPlayerMissionParticipantType>, cTkMetaDataXML::Registrar<cGcPlayerMissionParticipantType>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x233DD65A730CE9DF,
    };
    enum
    {
        mu64TemplateHash = 0xECDE7A3D64070AF4,
    };
