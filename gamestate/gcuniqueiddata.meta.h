 ...
 */
class cGcUniqueIdData : cTkMetaData::Registrar<cGcUniqueIdData>, cTkMetaDataXML::Registrar<cGcUniqueIdData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xCA58D35FFFB37091,
    };
    enum
    {
        mu64TemplateHash = 0xB0959B82BA453EF8,
    };
