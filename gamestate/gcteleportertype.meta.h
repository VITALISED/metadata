 ...
 */
class cGcTeleporterType : cTkMetaData::Registrar<cGcTeleporterType>, cTkMetaDataXML::Registrar<cGcTeleporterType>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xECE6F42F8A522B34,
    };
    enum
    {
        mu64TemplateHash = 0xC9A0D4A857566650,
    };
