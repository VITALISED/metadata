 ...
 * @class cGcPetData
 */
class cGcPetData : cTkMetaData::Registrar<cGcPetData>, cTkMetaDataXML::Registrar<cGcPetData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x995CD6C5BC075C98,
    };
    enum
    {
        mu64TemplateHash = 0x94B8F33BBE978540,
    };
