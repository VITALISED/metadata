/**
 * @file gcplayfabmatchmakingattributes.meta.h
 ...
 */
class cGcPlayfabMatchmakingAttributes : cTkMetaData::Registrar<cGcPlayfabMatchmakingAttributes>, cTkMetaDataXML::Registrar<cGcPlayfabMatchmakingAttributes>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x49457F0F4ABEDEE6,
    };
    enum
    {
        mu64TemplateHash = 0x7CB74261EDC1603B,
    };
