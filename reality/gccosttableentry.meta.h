 ...
 */
class cGcCostTableEntry : cTkMetaData::Registrar<cGcCostTableEntry>, cTkMetaDataXML::Registrar<cGcCostTableEntry>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x5923C0EE4B9AD427,
    };
    enum
    {
        mu64TemplateHash = 0x2584AB024B6EDC1F,
    };
