 ...
 */
class cGcRewardDeath : cTkMetaData::Registrar<cGcRewardDeath>, cTkMetaDataXML::Registrar<cGcRewardDeath>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xAF7590464B3BC984,
    };
    enum
    {
        mu64TemplateHash = 0x1054EE521BB65CEC,
    };
