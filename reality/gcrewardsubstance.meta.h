 ...
 */
class cGcRewardSubstance : cTkMetaData::Registrar<cGcRewardSubstance>, cTkMetaDataXML::Registrar<cGcRewardSubstance>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x3DDFD92393C0D347,
    };
    enum
    {
        mu64TemplateHash = 0x14FFC7609444086C,
    };
