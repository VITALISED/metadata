/**
 * @file gcrewardupgradebase.meta.h
 ...
 */
enum eUpgradeBaseType : uint32_t
{
 ...
 */
class cGcRewardUpgradeBase : cTkMetaData::Registrar<cGcRewardUpgradeBase>, cTkMetaDataXML::Registrar<cGcRewardUpgradeBase>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xE60E16C73CCFBAC0,
    };
    enum
    {
        mu64TemplateHash = 0xFFE472115B564B2D,
    };
