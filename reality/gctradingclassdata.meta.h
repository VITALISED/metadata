 ...
 */
class cGcTradingClassData : cTkMetaData::Registrar<cGcTradingClassData>, cTkMetaDataXML::Registrar<cGcTradingClassData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xB0C75D0F1E252081,
    };
    enum
    {
        mu64TemplateHash = 0xFE8A924B1CD0A55E,
    };
