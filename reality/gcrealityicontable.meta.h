 ...
 */
class cGcRealityIconTable : cTkMetaData::Registrar<cGcRealityIconTable>, cTkMetaDataXML::Registrar<cGcRealityIconTable>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x2A28407EECDFA4CC,
    };
    enum
    {
        mu64TemplateHash = 0x697FC0BB94821DD3,
    };
