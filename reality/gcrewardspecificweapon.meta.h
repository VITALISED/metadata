/**
 * @file gcrewardspecificweapon.meta.h
 ...
 */
class cGcRewardSpecificWeapon : cTkMetaData::Registrar<cGcRewardSpecificWeapon>, cTkMetaDataXML::Registrar<cGcRewardSpecificWeapon>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xF3710AB8A6F40A88,
    };
    enum
    {
        mu64TemplateHash = 0x7125A5C6424DD767,
    };
