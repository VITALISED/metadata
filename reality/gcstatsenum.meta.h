 ...
 * @class cGcStatsEnum
 */
class cGcStatsEnum : cTkMetaData::Registrar<cGcStatsEnum>, cTkMetaDataXML::Registrar<cGcStatsEnum>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xACDE6E8DA19EC2E2,
    };
    enum
    {
        mu64TemplateHash = 0xA5C5AEF74A763E5,
    };
