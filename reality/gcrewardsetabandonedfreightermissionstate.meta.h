...
class cGcRewardSetAbandonedFreighterMissionState
{
  public:
    enum
    {
        ClassNameHash = 0xDEABEB9DAFEFB3D9,
    };

    inline cGcRewardSetAbandonedFreighterMissionState() {}
    cGcRewardSetAbandonedFreighterMissionState* Cast(cTkClassPointer* lClassPtr);
