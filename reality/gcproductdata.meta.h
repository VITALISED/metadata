 ...
 */
class cGcProductData : cTkMetaData::Registrar<cGcProductData>, cTkMetaDataXML::Registrar<cGcProductData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xE831C8A241FD8276,
    };
    enum
    {
        mu64TemplateHash = 0xC8BD0ABA9E49767F,
    };
