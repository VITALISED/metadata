 ...
 */
class cGcRewardSpecificFrigate : cTkMetaData::Registrar<cGcRewardSpecificFrigate>, cTkMetaDataXML::Registrar<cGcRewardSpecificFrigate>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xB9F3B9FAC994498B,
    };
    enum
    {
        mu64TemplateHash = 0x1643846F26B79DF3,
    };
