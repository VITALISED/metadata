 ...
 */
class cGcAlienPuzzleOption : cTkMetaData::Registrar<cGcAlienPuzzleOption>, cTkMetaDataXML::Registrar<cGcAlienPuzzleOption>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x3FE862FE8570BE69,
    };
    enum
    {
        mu64TemplateHash = 0xE619E6DFA20C25A2,
    };
