/**
 * @file gcrewardspecificproduct.meta.h
 ...
 */
class cGcRewardSpecificProduct : cTkMetaData::Registrar<cGcRewardSpecificProduct>, cTkMetaDataXML::Registrar<cGcRewardSpecificProduct>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x691B32769ECE3BC6,
    };
    enum
    {
        mu64TemplateHash = 0x54DD0DBD5DAB09E9,
    };
