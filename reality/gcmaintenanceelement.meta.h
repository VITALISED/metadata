 ...
 */
class cGcMaintenanceElement : cTkMetaData::Registrar<cGcMaintenanceElement>, cTkMetaDataXML::Registrar<cGcMaintenanceElement>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x79BDBA7746F3C796,
    };
    enum
    {
        mu64TemplateHash = 0xC7878A2059B371AB,
    };
