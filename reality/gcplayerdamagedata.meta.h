 ...
 */
class cGcPlayerDamageData : cTkMetaData::Registrar<cGcPlayerDamageData>, cTkMetaDataXML::Registrar<cGcPlayerDamageData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x5F9BF82F9925D932,
    };
    enum
    {
        mu64TemplateHash = 0x1E4BCD483220FC93,
    };
