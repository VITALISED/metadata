/**
 * @file gcrealitygameicons.meta.h
 ...
 */
class cGcRealityGameIcons : cTkMetaData::Registrar<cGcRealityGameIcons>, cTkMetaDataXML::Registrar<cGcRealityGameIcons>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x878911013D83AEE9,
    };
    enum
    {
        mu64TemplateHash = 0xEFFA7BD969859911,
    };
