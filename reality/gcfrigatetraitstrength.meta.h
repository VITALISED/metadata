 ...
 */
class cGcFrigateTraitStrength : cTkMetaData::Registrar<cGcFrigateTraitStrength>, cTkMetaDataXML::Registrar<cGcFrigateTraitStrength>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x6B6B42D850BF9519,
    };
    enum
    {
        mu64TemplateHash = 0xB0B0A7490B06DF04,
    };
