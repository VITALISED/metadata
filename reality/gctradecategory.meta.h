 ...
 */
class cGcTradeCategory : cTkMetaData::Registrar<cGcTradeCategory>, cTkMetaDataXML::Registrar<cGcTradeCategory>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xABEDBCE191703616,
    };
    enum
    {
        mu64TemplateHash = 0xFA160E0C402E2DCA,
    };
