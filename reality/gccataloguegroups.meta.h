 ...
 */
class cGcCatalogueGroups : cTkMetaData::Registrar<cGcCatalogueGroups>, cTkMetaDataXML::Registrar<cGcCatalogueGroups>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x9A93F045019746C1,
    };
    enum
    {
        mu64TemplateHash = 0x261CB4A6885077DC,
    };
