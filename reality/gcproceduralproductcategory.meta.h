 ...
 */
class cGcProceduralProductCategory : cTkMetaData::Registrar<cGcProceduralProductCategory>, cTkMetaDataXML::Registrar<cGcProceduralProductCategory>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xE70B813560D9BFCE,
    };
    enum
    {
        mu64TemplateHash = 0xFA93FE2A4CC8CA8A,
    };
