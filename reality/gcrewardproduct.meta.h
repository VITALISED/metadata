 ...
 */
class cGcRewardProduct : cTkMetaData::Registrar<cGcRewardProduct>, cTkMetaDataXML::Registrar<cGcRewardProduct>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x893933F89479A7D8,
    };
    enum
    {
        mu64TemplateHash = 0x45FAC0221192A379,
    };
