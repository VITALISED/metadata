 ...
 */
class cGcPhotoBuilding : cTkMetaData::Registrar<cGcPhotoBuilding>, cTkMetaDataXML::Registrar<cGcPhotoBuilding>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x2535C1B3F76633D,
    };
    enum
    {
        mu64TemplateHash = 0x27529A5C3BAF0D45,
    };
