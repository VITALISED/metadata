 ...
 */
class cGcCustomisationComponentData : cTkMetaData::Registrar<cGcCustomisationComponentData>, cTkMetaDataXML::Registrar<cGcCustomisationComponentData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x52B0589631E97AC5,
    };
    enum
    {
        mu64TemplateHash = 0xD42BD8870A05E97F,
    };
