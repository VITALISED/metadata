/**
 * @file gcnpcanimationsetdata.meta.h
 ...
 */
class cGcNPCAnimationSetData : cTkMetaData::Registrar<cGcNPCAnimationSetData>, cTkMetaDataXML::Registrar<cGcNPCAnimationSetData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xF3A35A6135FAD505,
    };
    enum
    {
        mu64TemplateHash = 0xE00D51FF9EA5A779,
    };
