 ...
 */
class cGcNPCInteractiveObjectState : cTkMetaData::Registrar<cGcNPCInteractiveObjectState>, cTkMetaDataXML::Registrar<cGcNPCInteractiveObjectState>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x8D18F9F6D2A592B3,
    };
    enum
    {
        mu64TemplateHash = 0xD19C0E4EBABA1360,
    };
