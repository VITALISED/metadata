 ...
 */
class cGcNPCSpawnTable : cTkMetaData::Registrar<cGcNPCSpawnTable>, cTkMetaDataXML::Registrar<cGcNPCSpawnTable>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xEF1AB4FE11FCFA6D,
    };
    enum
    {
        mu64TemplateHash = 0x6CE80CDD523D33CE,
    };
