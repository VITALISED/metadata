 ...
 */
class cGcNPCSettlementBehaviourState : cTkMetaData::Registrar<cGcNPCSettlementBehaviourState>, cTkMetaDataXML::Registrar<cGcNPCSettlementBehaviourState>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x36730B94549148DE,
    };
    enum
    {
        mu64TemplateHash = 0xCE0743B4909D405A,
    };
