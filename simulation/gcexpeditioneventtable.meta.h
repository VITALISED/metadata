/**
 * @file gcexpeditioneventtable.meta.h
 ...
 */
class cGcExpeditionEventTable : cTkMetaData::Registrar<cGcExpeditionEventTable>, cTkMetaDataXML::Registrar<cGcExpeditionEventTable>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xD5BCFB328D8A80A8,
    };
    enum
    {
        mu64TemplateHash = 0xD6EA01BF44C4D0EA,
    };
