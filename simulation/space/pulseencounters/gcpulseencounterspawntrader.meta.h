 ...
 */
class cGcPulseEncounterSpawnTrader : cTkMetaData::Registrar<cGcPulseEncounterSpawnTrader>, cTkMetaDataXML::Registrar<cGcPulseEncounterSpawnTrader>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x61E014828AD14CD,
    };
    enum
    {
        mu64TemplateHash = 0x7BE1C328EE224011,
    };
