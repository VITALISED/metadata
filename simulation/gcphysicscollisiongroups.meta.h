 ...
 */
class cGcPhysicsCollisionGroups : cTkMetaData::Registrar<cGcPhysicsCollisionGroups>, cTkMetaDataXML::Registrar<cGcPhysicsCollisionGroups>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x29A5D23AA5A4C794,
    };
    enum
    {
        mu64TemplateHash = 0x33871F8C1A70C814,
    };
