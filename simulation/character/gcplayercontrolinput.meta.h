/**
 * @file gcplayercontrolinput.meta.h
 ...
 */
class cGcPlayerControlInput : cTkMetaData::Registrar<cGcPlayerControlInput>, cTkMetaDataXML::Registrar<cGcPlayerControlInput>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xD2873CCA9A0EDD77,
    };
    enum
    {
        mu64TemplateHash = 0x3195411FB3EE778B,
    };
