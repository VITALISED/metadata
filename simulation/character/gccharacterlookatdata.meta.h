 ...
 */
class cGcCharacterLookAtData : cTkMetaData::Registrar<cGcCharacterLookAtData>, cTkMetaDataXML::Registrar<cGcCharacterLookAtData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x566CA1D9F6501832,
    };
    enum
    {
        mu64TemplateHash = 0x4955099D564BF21D,
    };
