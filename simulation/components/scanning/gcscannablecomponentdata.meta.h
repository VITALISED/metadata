 ...
 */
class cGcScannableComponentData : cTkMetaData::Registrar<cGcScannableComponentData>, cTkMetaDataXML::Registrar<cGcScannableComponentData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x74BA808E86F0EC01,
    };
    enum
    {
        mu64TemplateHash = 0x99F74C03F8948E2C,
    };
