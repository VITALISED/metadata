 ...
 */
class cGcOutpostComponentData : cTkMetaData::Registrar<cGcOutpostComponentData>, cTkMetaDataXML::Registrar<cGcOutpostComponentData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x184558FBF0A370E2,
    };
    enum
    {
        mu64TemplateHash = 0xEB9332FF5C26A774,
    };
