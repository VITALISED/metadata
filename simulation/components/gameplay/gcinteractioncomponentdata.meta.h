 ...
 */
class cGcInteractionComponentData : cTkMetaData::Registrar<cGcInteractionComponentData>, cTkMetaDataXML::Registrar<cGcInteractionComponentData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xDAB0554EA36957B5,
    };
    enum
    {
        mu64TemplateHash = 0x345DED12B36153C4,
    };
