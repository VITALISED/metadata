 ...
 */
class cGcMaintenanceComponentData : cTkMetaData::Registrar<cGcMaintenanceComponentData>, cTkMetaDataXML::Registrar<cGcMaintenanceComponentData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x479CFCB871ABBE0,
    };
    enum
    {
        mu64TemplateHash = 0x508485AA3B7F83E0,
    };
