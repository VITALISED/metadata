 ...
 */
class cGcObjectSpawnDataArray : cTkMetaData::Registrar<cGcObjectSpawnDataArray>, cTkMetaDataXML::Registrar<cGcObjectSpawnDataArray>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x3AAEFA9CCB9353C1,
    };
    enum
    {
        mu64TemplateHash = 0x501E9D30483F120B,
    };
