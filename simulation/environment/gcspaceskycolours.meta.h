 ...
 */
class cGcSpaceSkyColours : cTkMetaData::Registrar<cGcSpaceSkyColours>, cTkMetaDataXML::Registrar<cGcSpaceSkyColours>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x488F8DF6F4A99ACA,
    };
    enum
    {
        mu64TemplateHash = 0xCBB68BF4033F6629,
    };
