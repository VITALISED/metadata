 ...
 */
class cGcExternalObjectListOptions : cTkMetaData::Registrar<cGcExternalObjectListOptions>, cTkMetaDataXML::Registrar<cGcExternalObjectListOptions>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x51E8334202D1B952,
    };
    enum
    {
        mu64TemplateHash = 0xB27A8358427627CA,
    };
