 ...
 */
class cGcBuildingSystemTypeEnum : cTkMetaData::Registrar<cGcBuildingSystemTypeEnum>, cTkMetaDataXML::Registrar<cGcBuildingSystemTypeEnum>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xB4AC262382F5910E,
    };
    enum
    {
        mu64TemplateHash = 0xD529A470EDDCF735,
    };
