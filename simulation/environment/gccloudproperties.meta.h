 ...
 */
class cGcCloudProperties : cTkMetaData::Registrar<cGcCloudProperties>, cTkMetaDataXML::Registrar<cGcCloudProperties>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x21C58A0DDEF4EC87,
    };
    enum
    {
        mu64TemplateHash = 0xACC78F5C88ED57CC,
    };
