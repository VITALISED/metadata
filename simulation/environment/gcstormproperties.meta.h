 ...
 */
class cGcStormProperties : cTkMetaData::Registrar<cGcStormProperties>, cTkMetaDataXML::Registrar<cGcStormProperties>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x82B1B19A1A57F975,
    };
    enum
    {
        mu64TemplateHash = 0xA85160500E3060F0,
    };
