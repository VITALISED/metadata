 ...
 */
class cGcFogProperties : cTkMetaData::Registrar<cGcFogProperties>, cTkMetaDataXML::Registrar<cGcFogProperties>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x32F1C073DAE21750,
    };
    enum
    {
        mu64TemplateHash = 0x35844421A6C552B4,
    };
