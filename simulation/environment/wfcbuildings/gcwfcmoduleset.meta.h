 ...
 */
class cGcWFCModuleSet : cTkMetaData::Registrar<cGcWFCModuleSet>, cTkMetaDataXML::Registrar<cGcWFCModuleSet>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x12D00A471DB28074,
    };
    enum
    {
        mu64TemplateHash = 0x717FDA53500C424,
    };
