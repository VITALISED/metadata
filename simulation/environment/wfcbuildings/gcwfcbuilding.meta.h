 ...
 */
class cGcWFCBuilding : cTkMetaData::Registrar<cGcWFCBuilding>, cTkMetaDataXML::Registrar<cGcWFCBuilding>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x42C648ED396E4B44,
    };
    enum
    {
        mu64TemplateHash = 0xEFF0648CC00F8AB8,
    };
