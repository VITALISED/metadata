 ...
 */
class cGcWFCTerrainConstraint : cTkMetaData::Registrar<cGcWFCTerrainConstraint>, cTkMetaDataXML::Registrar<cGcWFCTerrainConstraint>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xF0679B25F5343B25,
    };
    enum
    {
        mu64TemplateHash = 0x48FCC1BDF4A692B3,
    };
