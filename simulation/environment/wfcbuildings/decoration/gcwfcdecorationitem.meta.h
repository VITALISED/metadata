 ...
 */
class cGcWFCDecorationItem : cTkMetaData::Registrar<cGcWFCDecorationItem>, cTkMetaDataXML::Registrar<cGcWFCDecorationItem>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x9DDB490E0E777CD8,
    };
    enum
    {
        mu64TemplateHash = 0x37516E17AC76EC4E,
    };
