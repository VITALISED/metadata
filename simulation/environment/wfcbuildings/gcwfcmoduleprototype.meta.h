 ...
 */
class cGcWFCModulePrototype : cTkMetaData::Registrar<cGcWFCModulePrototype>, cTkMetaDataXML::Registrar<cGcWFCModulePrototype>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xEB956F6AA5C15F5C,
    };
    enum
    {
        mu64TemplateHash = 0x74D021303F06166E,
    };
