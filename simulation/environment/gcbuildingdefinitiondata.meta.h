 ...
 */
class cGcBuildingDefinitionData : cTkMetaData::Registrar<cGcBuildingDefinitionData>, cTkMetaDataXML::Registrar<cGcBuildingDefinitionData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x59A43238181BB69F,
    };
    enum
    {
        mu64TemplateHash = 0x4EB2192DB02EF8F2,
    };
