 ...
 */
class cGcEnvironmentSpawnData : cTkMetaData::Registrar<cGcEnvironmentSpawnData>, cTkMetaDataXML::Registrar<cGcEnvironmentSpawnData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x1B03CB87DECA6BCC,
    };
    enum
    {
        mu64TemplateHash = 0xA77C761194465BA6,
    };
