/**
 * @file gcweatherhazardlightningdata.meta.h
 ...
 */
class cGcWeatherHazardLightningData : cTkMetaData::Registrar<cGcWeatherHazardLightningData>, cTkMetaDataXML::Registrar<cGcWeatherHazardLightningData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xD85F7F00F1F64BD1,
    };
    enum
    {
        mu64TemplateHash = 0xC42BA76B22AFE894,
    };
