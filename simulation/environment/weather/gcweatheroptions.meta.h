 ...
 */
class cGcWeatherOptions : cTkMetaData::Registrar<cGcWeatherOptions>, cTkMetaDataXML::Registrar<cGcWeatherOptions>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xA2AEA53FED6497EC,
    };
    enum
    {
        mu64TemplateHash = 0x60CDE501516F083F,
    };
