 ...
 */
class cGcWeatherProperties : cTkMetaData::Registrar<cGcWeatherProperties>, cTkMetaDataXML::Registrar<cGcWeatherProperties>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xD216CE8E772352C,
    };
    enum
    {
        mu64TemplateHash = 0xBDD9439B9B595EF6,
    };
