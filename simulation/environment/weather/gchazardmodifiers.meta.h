 ...
 */
class cGcHazardModifiers : cTkMetaData::Registrar<cGcHazardModifiers>, cTkMetaDataXML::Registrar<cGcHazardModifiers>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x8D86E8499B88B845,
    };
    enum
    {
        mu64TemplateHash = 0x17F28D0AC13F281E,
    };
