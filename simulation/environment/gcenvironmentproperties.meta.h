 ...
 */
class cGcEnvironmentProperties : cTkMetaData::Registrar<cGcEnvironmentProperties>, cTkMetaDataXML::Registrar<cGcEnvironmentProperties>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xB125AED843BB9164,
    };
    enum
    {
        mu64TemplateHash = 0x5878DB43951227CC,
    };
