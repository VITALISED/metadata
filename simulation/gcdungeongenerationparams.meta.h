 ...
 */
class cGcDungeonGenerationParams : cTkMetaData::Registrar<cGcDungeonGenerationParams>, cTkMetaDataXML::Registrar<cGcDungeonGenerationParams>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xFD9E29934900184E,
    };
    enum
    {
        mu64TemplateHash = 0xAA790A943816F13C,
    };
