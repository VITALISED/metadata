 ...
 * @class cGcDroneData
 */
class cGcDroneData : cTkMetaData::Registrar<cGcDroneData>, cTkMetaDataXML::Registrar<cGcDroneData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xC42B2790FC61E0A9,
    };
    enum
    {
        mu64TemplateHash = 0x56497BC5426DAD98,
    };
