 ...
 */
class cGcDroneWeaponData : cTkMetaData::Registrar<cGcDroneWeaponData>, cTkMetaDataXML::Registrar<cGcDroneWeaponData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x7652773CA720B160,
    };
    enum
    {
        mu64TemplateHash = 0x16F8728F6FC68AAF,
    };
