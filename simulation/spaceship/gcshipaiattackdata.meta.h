 ...
 */
class cGcShipAIAttackData : cTkMetaData::Registrar<cGcShipAIAttackData>, cTkMetaDataXML::Registrar<cGcShipAIAttackData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xA9C402167AF9D69B,
    };
    enum
    {
        mu64TemplateHash = 0xE631E6FFCC918379,
    };
