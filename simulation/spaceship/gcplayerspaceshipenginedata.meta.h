/**
 * @file gcplayerspaceshipenginedata.meta.h
 ...
 */
class cGcPlayerSpaceshipEngineData : cTkMetaData::Registrar<cGcPlayerSpaceshipEngineData>, cTkMetaDataXML::Registrar<cGcPlayerSpaceshipEngineData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x1C062102935FA221,
    };
    enum
    {
        mu64TemplateHash = 0x8676B7E0F7721711,
    };
