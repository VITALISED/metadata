 ...
 */
class cGcPlayerSpaceshipControlData : cTkMetaData::Registrar<cGcPlayerSpaceshipControlData>, cTkMetaDataXML::Registrar<cGcPlayerSpaceshipControlData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x49B6F6CA72CF5A3F,
    };
    enum
    {
        mu64TemplateHash = 0x96267977B10C1DE0,
    };
