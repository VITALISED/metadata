 ...
 */
class cGcAISpaceshipPreloadCacheData : cTkMetaData::Registrar<cGcAISpaceshipPreloadCacheData>, cTkMetaDataXML::Registrar<cGcAISpaceshipPreloadCacheData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x74723646531009E2,
    };
    enum
    {
        mu64TemplateHash = 0x4339BE7A302ECC05,
    };
