/**
 * @file gcaispaceshipcomponentdata.meta.h
 ...
 */
class cGcAISpaceshipComponentData : cTkMetaData::Registrar<cGcAISpaceshipComponentData>, cTkMetaDataXML::Registrar<cGcAISpaceshipComponentData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x4F5433BCFC028B49,
    };
    enum
    {
        mu64TemplateHash = 0xC53919B53D4EA93E,
    };
