 ...
 */
class cGcAIShipSpawnData : cTkMetaData::Registrar<cGcAIShipSpawnData>, cTkMetaDataXML::Registrar<cGcAIShipSpawnData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x35C91009067A6431,
    };
    enum
    {
        mu64TemplateHash = 0x9CE6A6ED6DE9D4B5,
    };
