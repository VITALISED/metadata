 ...
 */
class cGcPlayerSquadronConfig : cTkMetaData::Registrar<cGcPlayerSquadronConfig>, cTkMetaDataXML::Registrar<cGcPlayerSquadronConfig>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xD3C0DCB43542B48,
    };
    enum
    {
        mu64TemplateHash = 0xC9827D633B336FF4,
    };
