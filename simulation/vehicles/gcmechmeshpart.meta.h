 ...
 */
class cGcMechMeshPart : cTkMetaData::Registrar<cGcMechMeshPart>, cTkMetaDataXML::Registrar<cGcMechMeshPart>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x78242DA1B96F48FC,
    };
    enum
    {
        mu64TemplateHash = 0x9DE40488BE597ACC,
    };
