/**
 * @file gcmechaudioeventtable.meta.h
 ...
 */
class cGcMechAudioEventTable : cTkMetaData::Registrar<cGcMechAudioEventTable>, cTkMetaDataXML::Registrar<cGcMechAudioEventTable>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xEAC7A07BBA50D64B,
    };
    enum
    {
        mu64TemplateHash = 0xDB4DCA895EB479AC,
    };
