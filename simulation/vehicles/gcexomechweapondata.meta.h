/**
 * @file gcexomechweapondata.meta.h
 ...
 */
class cGcExoMechWeaponData : cTkMetaData::Registrar<cGcExoMechWeaponData>, cTkMetaDataXML::Registrar<cGcExoMechWeaponData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xAB111A88D43A92B4,
    };
    enum
    {
        mu64TemplateHash = 0x34E79E36B5462BA,
    };
