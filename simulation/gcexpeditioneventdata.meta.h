 ...
 */
class cGcExpeditionEventData : cTkMetaData::Registrar<cGcExpeditionEventData>, cTkMetaDataXML::Registrar<cGcExpeditionEventData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x48A0FEC50BBF269C,
    };
    enum
    {
        mu64TemplateHash = 0x228F0F1AFB532DB0,
    };
