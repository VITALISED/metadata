 ...
 */
class cGcTargetMissionSurveyOptions : cTkMetaData::Registrar<cGcTargetMissionSurveyOptions>, cTkMetaDataXML::Registrar<cGcTargetMissionSurveyOptions>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x4E7A7CEB00A9346B,
    };
    enum
    {
        mu64TemplateHash = 0xC5A9DABEAEFD7DEE,
    };
