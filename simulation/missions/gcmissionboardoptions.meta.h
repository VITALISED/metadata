 ...
 */
class cGcMissionBoardOptions : cTkMetaData::Registrar<cGcMissionBoardOptions>, cTkMetaDataXML::Registrar<cGcMissionBoardOptions>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xDD272E15749CCDF5,
    };
    enum
    {
        mu64TemplateHash = 0xFC68B7B7649C4567,
    };
