/**
 * @file gcmissionsequencewaitforconditions.meta.h
 ...
 */
class cGcMissionSequenceWaitForConditions : cTkMetaData::Registrar<cGcMissionSequenceWaitForConditions>, cTkMetaDataXML::Registrar<cGcMissionSequenceWaitForConditions>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x677779252EE27773,
    };
    enum
    {
        mu64TemplateHash = 0xBA4ADED1901B82DD,
    };
