...
class cGcMissionSequenceCreateSpecificPulseEncounter
{
  public:
    enum
    {
        ClassNameHash = 0x245D62E60DEB8B1E,
    };

    inline cGcMissionSequenceCreateSpecificPulseEncounter() {}
    cGcMissionSequenceCreateSpecificPulseEncounter* Cast(cTkClassPointer* lClassPtr);
