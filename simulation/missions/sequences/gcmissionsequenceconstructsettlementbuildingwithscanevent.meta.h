 ...
 */
class cGcMissionSequenceConstructSettlementBuildingWithScanEvent : cTkMetaData::Registrar<cGcMissionSequenceConstructSettlementBuildingWithScanEvent>, cTkMetaDataXML::Registrar<cGcMissionSequenceConstructSettlementBuildingWithScanEvent>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x9DC327D85EF1681E,
    };
    enum
    {
        mu64TemplateHash = 0x994472AEF21AC74F,
    };
