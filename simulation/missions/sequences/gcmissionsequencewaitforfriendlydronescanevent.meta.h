...
class cGcMissionSequenceWaitForFriendlyDroneScanEvent
{
  public:
    enum
    {
        ClassNameHash = 0xD5B668729A28BD2C,
    };

    inline cGcMissionSequenceWaitForFriendlyDroneScanEvent() {}
    cGcMissionSequenceWaitForFriendlyDroneScanEvent* Cast(cTkClassPointer* lClassPtr);
