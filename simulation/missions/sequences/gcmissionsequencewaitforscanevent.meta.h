 ...
 */
class cGcMissionSequenceWaitForScanEvent : cTkMetaData::Registrar<cGcMissionSequenceWaitForScanEvent>, cTkMetaDataXML::Registrar<cGcMissionSequenceWaitForScanEvent>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xCFE8C2198256BF63,
    };
    enum
    {
        mu64TemplateHash = 0x47C4AA7111F66BA,
    };
