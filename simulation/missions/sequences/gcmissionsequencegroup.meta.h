 ...
 */
class cGcMissionSequenceGroup : cTkMetaData::Registrar<cGcMissionSequenceGroup>, cTkMetaDataXML::Registrar<cGcMissionSequenceGroup>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x51B3554FFBEBED66,
    };
    enum
    {
        mu64TemplateHash = 0xB370FD96C3A251EC,
    };
