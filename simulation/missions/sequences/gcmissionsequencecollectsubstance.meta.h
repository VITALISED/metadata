 ...
 */
class cGcMissionSequenceCollectSubstance : cTkMetaData::Registrar<cGcMissionSequenceCollectSubstance>, cTkMetaDataXML::Registrar<cGcMissionSequenceCollectSubstance>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x84D6228673F661A6,
    };
    enum
    {
        mu64TemplateHash = 0x719B3F025CECFCC,
    };
