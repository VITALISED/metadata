...
class cGcMissionSequenceWaitForSettlementActivity
{
  public:
    enum
    {
        ClassNameHash = 0x13DC6DC343F05,
    };

    inline cGcMissionSequenceWaitForSettlementActivity() {}
    cGcMissionSequenceWaitForSettlementActivity* Cast(cTkClassPointer* lClassPtr);
