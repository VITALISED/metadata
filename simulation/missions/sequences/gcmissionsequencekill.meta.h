 ...
 */
class cGcMissionSequenceKill : cTkMetaData::Registrar<cGcMissionSequenceKill>, cTkMetaDataXML::Registrar<cGcMissionSequenceKill>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xF2F929BD28DDCD6B,
    };
    enum
    {
        mu64TemplateHash = 0x79A38FA0B68F95E0,
    };
