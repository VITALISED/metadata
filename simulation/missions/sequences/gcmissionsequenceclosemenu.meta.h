 ...
 */
class cGcMissionSequenceCloseMenu : cTkMetaData::Registrar<cGcMissionSequenceCloseMenu>, cTkMetaDataXML::Registrar<cGcMissionSequenceCloseMenu>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xE62B86A237CB0756,
    };
    enum
    {
        mu64TemplateHash = 0xC1ACA35E74A19273,
    };
