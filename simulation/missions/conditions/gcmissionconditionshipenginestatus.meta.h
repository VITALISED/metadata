 ...
 */
class cGcMissionConditionShipEngineStatus : cTkMetaData::Registrar<cGcMissionConditionShipEngineStatus>, cTkMetaDataXML::Registrar<cGcMissionConditionShipEngineStatus>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x9A43A9B870251F8C,
    };
    enum
    {
        mu64TemplateHash = 0x39385853D394BC7C,
    };
