 ...
 */
class cGcMissionConditionInventorySlots : cTkMetaData::Registrar<cGcMissionConditionInventorySlots>, cTkMetaDataXML::Registrar<cGcMissionConditionInventorySlots>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xF112AB8FC14A734A,
    };
    enum
    {
        mu64TemplateHash = 0xAB070DA8379B54B1,
    };
