 ...
 */
class cGcMissionConditionLocation : cTkMetaData::Registrar<cGcMissionConditionLocation>, cTkMetaDataXML::Registrar<cGcMissionConditionLocation>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x64A394B637C25752,
    };
    enum
    {
        mu64TemplateHash = 0xF1FF349FCBFB33CA,
    };
