...
class cGcMissionConditionUsingThirdPersonCamera
{
  public:
    enum
    {
        ClassNameHash = 0x1966AFFB10CA6C7C,
    };

    inline cGcMissionConditionUsingThirdPersonCamera() {}
    cGcMissionConditionUsingThirdPersonCamera* Cast(cTkClassPointer* lClassPtr);
