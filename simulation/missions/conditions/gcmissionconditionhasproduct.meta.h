/**
 * @file gcmissionconditionhasproduct.meta.h
 ...
 */
class cGcMissionConditionHasProduct : cTkMetaData::Registrar<cGcMissionConditionHasProduct>, cTkMetaDataXML::Registrar<cGcMissionConditionHasProduct>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x9537448E73030512,
    };
    enum
    {
        mu64TemplateHash = 0xAF0D07655CC416A5,
    };
