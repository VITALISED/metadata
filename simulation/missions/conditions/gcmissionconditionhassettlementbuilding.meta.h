...
class cGcMissionConditionHasSettlementBuilding
{
  public:
    enum
    {
        ClassNameHash = 0xE47353C2B9EE4F60,
    };

    inline cGcMissionConditionHasSettlementBuilding() {}
    cGcMissionConditionHasSettlementBuilding* Cast(cTkClassPointer* lClassPtr);
