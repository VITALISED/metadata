...
class cGcMissionConditionIsAbandFreighterDoorOpen
{
  public:
    enum
    {
        ClassNameHash = 0x337390D414A23798,
    };

    inline cGcMissionConditionIsAbandFreighterDoorOpen() {}
    cGcMissionConditionIsAbandFreighterDoorOpen* Cast(cTkClassPointer* lClassPtr);
