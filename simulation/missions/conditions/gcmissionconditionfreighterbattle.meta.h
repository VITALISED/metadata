 ...
 */
class cGcMissionConditionFreighterBattle : cTkMetaData::Registrar<cGcMissionConditionFreighterBattle>, cTkMetaDataXML::Registrar<cGcMissionConditionFreighterBattle>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xF8A296780D76172F,
    };
    enum
    {
        mu64TemplateHash = 0xCB7F989D6DA449DA,
    };
