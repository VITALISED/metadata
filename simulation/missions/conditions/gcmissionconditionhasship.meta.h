/**
 * @file gcmissionconditionhasship.meta.h
 ...
 */
class cGcMissionConditionHasShip : cTkMetaData::Registrar<cGcMissionConditionHasShip>, cTkMetaDataXML::Registrar<cGcMissionConditionHasShip>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x9511DDC4A0C718D3,
    };
    enum
    {
        mu64TemplateHash = 0x4377B1D9BF160FD4,
    };
