...
class cGcMissionConditionNPCHabitationHasWorker
{
  public:
    enum
    {
        ClassNameHash = 0x41BFFB2F8544AD51,
    };

    inline cGcMissionConditionNPCHabitationHasWorker() {}
    cGcMissionConditionNPCHabitationHasWorker* Cast(cTkClassPointer* lClassPtr);
