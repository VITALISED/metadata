 ...
 */
class cGcGenericMissionSequence : cTkMetaData::Registrar<cGcGenericMissionSequence>, cTkMetaDataXML::Registrar<cGcGenericMissionSequence>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xFAE86B2801335B6D,
    };
    enum
    {
        mu64TemplateHash = 0xA5D439E96EBCE89D,
    };
