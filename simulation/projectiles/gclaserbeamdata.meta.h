 ...
 */
class cGcLaserBeamData : cTkMetaData::Registrar<cGcLaserBeamData>, cTkMetaDataXML::Registrar<cGcLaserBeamData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x1AA966F8BA4E3153,
    };
    enum
    {
        mu64TemplateHash = 0xF076564F20014911,
    };
