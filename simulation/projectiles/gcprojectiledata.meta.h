 ...
 */
class cGcProjectileData : cTkMetaData::Registrar<cGcProjectileData>, cTkMetaDataXML::Registrar<cGcProjectileData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x98B648B5C054B7F7,
    };
    enum
    {
        mu64TemplateHash = 0x37F1B214BC74234A,
    };
