 ...
 * @class cGcDamageType
 */
class cGcDamageType : cTkMetaData::Registrar<cGcDamageType>, cTkMetaDataXML::Registrar<cGcDamageType>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xCD0F83EA324443E1,
    };
    enum
    {
        mu64TemplateHash = 0x3CC505295BDAFC43,
    };
