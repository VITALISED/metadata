/**
 * @file gcplayercharacterstatedata.meta.h
 ...
 */
class cGcPlayerCharacterStateData : cTkMetaData::Registrar<cGcPlayerCharacterStateData>, cTkMetaDataXML::Registrar<cGcPlayerCharacterStateData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xCCEE5C02303ACEC6,
    };
    enum
    {
        mu64TemplateHash = 0xFC07380B8762421C,
    };
