 ...
 */
class cGcShipWeaponData : cTkMetaData::Registrar<cGcShipWeaponData>, cTkMetaDataXML::Registrar<cGcShipWeaponData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x73BA1311CF8E1962,
    };
    enum
    {
        mu64TemplateHash = 0x22F67703D63F082D,
    };
