 ...
 */
class cGcPetAccessoryType : cTkMetaData::Registrar<cGcPetAccessoryType>, cTkMetaDataXML::Registrar<cGcPetAccessoryType>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xB47279F1694E0681,
    };
    enum
    {
        mu64TemplateHash = 0xD19A2E040F8046A2,
    };
