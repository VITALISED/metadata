 ...
 */
class cGcCreatureSpawnEnum : cTkMetaData::Registrar<cGcCreatureSpawnEnum>, cTkMetaDataXML::Registrar<cGcCreatureSpawnEnum>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xF1142B73FBEC2939,
    };
    enum
    {
        mu64TemplateHash = 0xC4D3D498FA5EAF4B,
    };
