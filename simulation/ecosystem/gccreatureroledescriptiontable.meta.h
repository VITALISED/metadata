/**
 * @file gccreatureroledescriptiontable.meta.h
 ...
 */
class cGcCreatureRoleDescriptionTable : cTkMetaData::Registrar<cGcCreatureRoleDescriptionTable>, cTkMetaDataXML::Registrar<cGcCreatureRoleDescriptionTable>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xBCFEFAC14ECD961B,
    };
    enum
    {
        mu64TemplateHash = 0x3BCE966DA1F26340,
    };
