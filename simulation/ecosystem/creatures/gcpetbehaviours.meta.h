 ...
 */
class cGcPetBehaviours : cTkMetaData::Registrar<cGcPetBehaviours>, cTkMetaDataXML::Registrar<cGcPetBehaviours>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x82204A5605D64063,
    };
    enum
    {
        mu64TemplateHash = 0xD8AD71C286DECFF3,
    };
