 ...
 */
class cGcCreatureInfo : cTkMetaData::Registrar<cGcCreatureInfo>, cTkMetaDataXML::Registrar<cGcCreatureInfo>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xE85F02E30BDAB35D,
    };
    enum
    {
        mu64TemplateHash = 0x9B6B93F108A31AE,
    };
