 ...
 */
class cGcPetBehaviourTable : cTkMetaData::Registrar<cGcPetBehaviourTable>, cTkMetaDataXML::Registrar<cGcPetBehaviourTable>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x39BD1ED2FC8D7524,
    };
    enum
    {
        mu64TemplateHash = 0x78F621A5B62DEA07,
    };
