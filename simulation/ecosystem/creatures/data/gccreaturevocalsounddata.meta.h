 ...
 */
class cGcCreatureVocalSoundData : cTkMetaData::Registrar<cGcCreatureVocalSoundData>, cTkMetaDataXML::Registrar<cGcCreatureVocalSoundData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x7FE7156AA587561F,
    };
    enum
    {
        mu64TemplateHash = 0xE5A63220EF7B73B5,
    };
