/**
 * @file gccreatureridingdata.meta.h
 ...
 */
class cGcCreatureRidingData : cTkMetaData::Registrar<cGcCreatureRidingData>, cTkMetaDataXML::Registrar<cGcCreatureRidingData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xCBC8926C6C9D9A51,
    };
    enum
    {
        mu64TemplateHash = 0xAEDEBE610D3F2531,
    };
