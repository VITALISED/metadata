 ...
 */
class cGcCreatureFlockMovementData : cTkMetaData::Registrar<cGcCreatureFlockMovementData>, cTkMetaDataXML::Registrar<cGcCreatureFlockMovementData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xED083CF705C39B97,
    };
    enum
    {
        mu64TemplateHash = 0xA55A702EC8C6D49F,
    };
