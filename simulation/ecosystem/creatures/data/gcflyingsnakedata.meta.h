 ...
 */
class cGcFlyingSnakeData : cTkMetaData::Registrar<cGcFlyingSnakeData>, cTkMetaDataXML::Registrar<cGcFlyingSnakeData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x8AE34D6AD8F2EB14,
    };
    enum
    {
        mu64TemplateHash = 0x912B8C84F2D13E72,
    };
