 ...
 */
class cGcCreatureSwarmData : cTkMetaData::Registrar<cGcCreatureSwarmData>, cTkMetaDataXML::Registrar<cGcCreatureSwarmData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x87C83AD7D0C1D117,
    };
    enum
    {
        mu64TemplateHash = 0xB3AED157D9B5E63,
    };
