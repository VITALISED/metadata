 ...
 */
class cGcCreatureTypes : cTkMetaData::Registrar<cGcCreatureTypes>, cTkMetaDataXML::Registrar<cGcCreatureTypes>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xF848BA9A5DFC4197,
    };
    enum
    {
        mu64TemplateHash = 0x79FB96ED0674516A,
    };
