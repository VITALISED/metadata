 ...
 */
class cGcBehaviourApplyDamageData : cTkMetaData::Registrar<cGcBehaviourApplyDamageData>, cTkMetaDataXML::Registrar<cGcBehaviourApplyDamageData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x88EF02AAFC25BCE6,
    };
    enum
    {
        mu64TemplateHash = 0xB185E9E89F4E3649,
    };
