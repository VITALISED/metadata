 ...
 */
class cGcGalaxyGenerationSetupData : cTkMetaData::Registrar<cGcGalaxyGenerationSetupData>, cTkMetaDataXML::Registrar<cGcGalaxyGenerationSetupData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x74E6E445263E30C1,
    };
    enum
    {
        mu64TemplateHash = 0xCD69498AB6E7B213,
    };
