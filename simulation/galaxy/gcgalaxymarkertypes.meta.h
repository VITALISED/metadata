 ...
 */
class cGcGalaxyMarkerTypes : cTkMetaData::Registrar<cGcGalaxyMarkerTypes>, cTkMetaDataXML::Registrar<cGcGalaxyMarkerTypes>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x29324EF951272232,
    };
    enum
    {
        mu64TemplateHash = 0x7B7270127FD40BB2,
    };
