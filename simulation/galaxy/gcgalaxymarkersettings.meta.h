 ...
 */
class cGcGalaxyMarkerSettings : cTkMetaData::Registrar<cGcGalaxyMarkerSettings>, cTkMetaDataXML::Registrar<cGcGalaxyMarkerSettings>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xB24FD22ADB1D885D,
    };
    enum
    {
        mu64TemplateHash = 0x9D337FA7A210A1B8,
    };
