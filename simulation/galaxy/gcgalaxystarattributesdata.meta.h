 ...
 */
class cGcGalaxyStarAttributesData : cTkMetaData::Registrar<cGcGalaxyStarAttributesData>, cTkMetaDataXML::Registrar<cGcGalaxyStarAttributesData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xEDE680300A536215,
    };
    enum
    {
        mu64TemplateHash = 0x636E887ED3223018,
    };
