 ...
 */
class cGcGalaxyInfoIcons : cTkMetaData::Registrar<cGcGalaxyInfoIcons>, cTkMetaDataXML::Registrar<cGcGalaxyInfoIcons>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x1DE42844C3529A0B,
    };
    enum
    {
        mu64TemplateHash = 0x7D3DB4E4A1077EA3,
    };
