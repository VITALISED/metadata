 ...
 * @class cGcDebugScene
 */
class cGcDebugScene : cTkMetaData::Registrar<cGcDebugScene>, cTkMetaDataXML::Registrar<cGcDebugScene>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xB5B196A1179FFE00,
    };
    enum
    {
        mu64TemplateHash = 0x6795C586BE70BA4E,
    };
