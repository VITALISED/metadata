 ...
 */
class cGcScanEventData : cTkMetaData::Registrar<cGcScanEventData>, cTkMetaDataXML::Registrar<cGcScanEventData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x7BBBCE7D7BC0F1F4,
    };
    enum
    {
        mu64TemplateHash = 0x5D2C5B4A197F412A,
    };
