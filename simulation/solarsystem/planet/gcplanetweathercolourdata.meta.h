 ...
 */
class cGcPlanetWeatherColourData : cTkMetaData::Registrar<cGcPlanetWeatherColourData>, cTkMetaDataXML::Registrar<cGcPlanetWeatherColourData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xA699A80ACABBB3C5,
    };
    enum
    {
        mu64TemplateHash = 0x79EC01ECC601AA7F,
    };
