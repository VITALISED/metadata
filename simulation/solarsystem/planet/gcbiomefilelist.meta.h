 ...
 */
class cGcBiomeFileList : cTkMetaData::Registrar<cGcBiomeFileList>, cTkMetaDataXML::Registrar<cGcBiomeFileList>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x369AF9F4E4E055D0,
    };
    enum
    {
        mu64TemplateHash = 0xCBE51C9993608260,
    };
