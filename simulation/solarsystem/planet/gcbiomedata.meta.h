 ...
 * @class cGcBiomeData
 */
class cGcBiomeData : cTkMetaData::Registrar<cGcBiomeData>, cTkMetaDataXML::Registrar<cGcBiomeData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x2FD5560612237D4D,
    };
    enum
    {
        mu64TemplateHash = 0xA369C87DCDDF335B,
    };
