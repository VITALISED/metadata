/**
 * @file gcsolarsystemskycolourdata.meta.h
 ...
 */
class cGcSolarSystemSkyColourData : cTkMetaData::Registrar<cGcSolarSystemSkyColourData>, cTkMetaDataXML::Registrar<cGcSolarSystemSkyColourData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x2C473DC1DB095F44,
    };
    enum
    {
        mu64TemplateHash = 0x3FCFDB1505B25B0D,
    };
