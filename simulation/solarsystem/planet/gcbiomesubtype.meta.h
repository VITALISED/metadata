 ...
 */
class cGcBiomeSubType : cTkMetaData::Registrar<cGcBiomeSubType>, cTkMetaDataXML::Registrar<cGcBiomeSubType>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xE8FE27493120750F,
    };
    enum
    {
        mu64TemplateHash = 0xAA4AA33B8FCAE03E,
    };
