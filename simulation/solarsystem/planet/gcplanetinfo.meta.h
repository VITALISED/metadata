 ...
 * @class cGcPlanetInfo
 */
class cGcPlanetInfo : cTkMetaData::Registrar<cGcPlanetInfo>, cTkMetaDataXML::Registrar<cGcPlanetInfo>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x458D53EF402BA3C9,
    };
    enum
    {
        mu64TemplateHash = 0x98F6CCB88342CA8,
    };
