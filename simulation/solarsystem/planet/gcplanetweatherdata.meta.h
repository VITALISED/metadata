 ...
 */
class cGcPlanetWeatherData : cTkMetaData::Registrar<cGcPlanetWeatherData>, cTkMetaDataXML::Registrar<cGcPlanetWeatherData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xEBF08BE1E3CAE3AC,
    };
    enum
    {
        mu64TemplateHash = 0x69F3C1EFE29BC64E,
    };
