 ...
 */
class cGcTerrainEditing : cTkMetaData::Registrar<cGcTerrainEditing>, cTkMetaDataXML::Registrar<cGcTerrainEditing>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x4686D0FAC0A1B9EC,
    };
    enum
    {
        mu64TemplateHash = 0x8879B10CF4B83AE,
    };
