 ...
 */
class cGcScanEventSolarSystemLookup : cTkMetaData::Registrar<cGcScanEventSolarSystemLookup>, cTkMetaDataXML::Registrar<cGcScanEventSolarSystemLookup>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xE523CFAD6AFB4BB6,
    };
    enum
    {
        mu64TemplateHash = 0xDC65FBB3D6D18DC4,
    };
