 ...
 */
class cGcMessageProjectileImpact : cTkMetaData::Registrar<cGcMessageProjectileImpact>, cTkMetaDataXML::Registrar<cGcMessageProjectileImpact>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x7EBC25FE326CF24B,
    };
    enum
    {
        mu64TemplateHash = 0xB7A09FEF0808E840,
    };
