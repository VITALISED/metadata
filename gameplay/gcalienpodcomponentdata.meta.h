/**
 * @file gcalienpodcomponentdata.meta.h
 ...
 */
class cGcAlienPodComponentData : cTkMetaData::Registrar<cGcAlienPodComponentData>, cTkMetaDataXML::Registrar<cGcAlienPodComponentData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x71B7896BF38DAAE4,
    };
    enum
    {
        mu64TemplateHash = 0x42BCABB3F2D44B9B,
    };
