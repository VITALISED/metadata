 ...
 */
class cGcFiendCrimeSpawnTable : cTkMetaData::Registrar<cGcFiendCrimeSpawnTable>, cTkMetaDataXML::Registrar<cGcFiendCrimeSpawnTable>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x4EBB7BDC5EE300EA,
    };
    enum
    {
        mu64TemplateHash = 0xF11ACFCECBC95ACF,
    };
