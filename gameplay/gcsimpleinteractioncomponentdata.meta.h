 ...
 */
class cGcSimpleInteractionComponentData : cTkMetaData::Registrar<cGcSimpleInteractionComponentData>, cTkMetaDataXML::Registrar<cGcSimpleInteractionComponentData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xEAE36C86E1479AF5,
    };
    enum
    {
        mu64TemplateHash = 0xA08E96856580D0A8,
    };
