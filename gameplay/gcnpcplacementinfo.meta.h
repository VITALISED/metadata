/**
 * @file gcnpcplacementinfo.meta.h
 ...
 */
class cGcNPCPlacementInfo : cTkMetaData::Registrar<cGcNPCPlacementInfo>, cTkMetaDataXML::Registrar<cGcNPCPlacementInfo>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xA12AC584067DF8E0,
    };
    enum
    {
        mu64TemplateHash = 0xBC234D69742168C,
    };
