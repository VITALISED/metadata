 ...
 */
class cGcPlayerExperienceSpawnData : cTkMetaData::Registrar<cGcPlayerExperienceSpawnData>, cTkMetaDataXML::Registrar<cGcPlayerExperienceSpawnData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x76E523097495B90,
    };
    enum
    {
        mu64TemplateHash = 0xB547ACA99002043A,
    };
