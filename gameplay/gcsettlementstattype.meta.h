 ...
 */
class cGcSettlementStatType : cTkMetaData::Registrar<cGcSettlementStatType>, cTkMetaDataXML::Registrar<cGcSettlementStatType>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x9394F46EDEDBE660,
    };
    enum
    {
        mu64TemplateHash = 0x7C86AE119BC952DC,
    };
