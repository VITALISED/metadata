/**
 * @file gcsettlementjudgementtype.meta.h
 ...
 */
enum eSettlementJudgementType : uint32_t
{
 ...
 */
class cGcSettlementJudgementType : cTkMetaData::Registrar<cGcSettlementJudgementType>, cTkMetaDataXML::Registrar<cGcSettlementJudgementType>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x9B6A014776B1F8BB,
    };
    enum
    {
        mu64TemplateHash = 0xBCAE176B666C6AF7,
    };
