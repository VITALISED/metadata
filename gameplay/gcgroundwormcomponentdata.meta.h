 ...
 */
class cGcGroundWormComponentData : cTkMetaData::Registrar<cGcGroundWormComponentData>, cTkMetaDataXML::Registrar<cGcGroundWormComponentData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x93C5F18EADCD6C3C,
    };
    enum
    {
        mu64TemplateHash = 0x5D4EF68A1BE622F5,
    };
