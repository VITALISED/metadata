...
class cGcPlayerExperienceAsteroidCreatureSpawnTable
{
  public:
    enum
    {
        ClassNameHash = 0xC49FE6E5B9227EF6,
    };

    inline cGcPlayerExperienceAsteroidCreatureSpawnTable() {}
    cGcPlayerExperienceAsteroidCreatureSpawnTable* Cast(cTkClassPointer* lClassPtr);
