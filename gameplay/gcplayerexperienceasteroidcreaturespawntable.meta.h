/**
 * @file gcplayerexperienceasteroidcreaturespawntable.meta.h
 ...
 */
class cGcPlayerExperienceAsteroidCreatureSpawnTable : cTkMetaData::Registrar<cGcPlayerExperienceAsteroidCreatureSpawnTable>, cTkMetaDataXML::Registrar<cGcPlayerExperienceAsteroidCreatureSpawnTable>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xC49FE6E5B9227EF6,
    };
    enum
    {
        mu64TemplateHash = 0x13686FB01961A6D,
    };
