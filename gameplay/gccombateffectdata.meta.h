/**
 * @file gccombateffectdata.meta.h
 ...
 */
class cGcCombatEffectData : cTkMetaData::Registrar<cGcCombatEffectData>, cTkMetaDataXML::Registrar<cGcCombatEffectData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x6D475929020A9A4D,
    };
    enum
    {
        mu64TemplateHash = 0x167EFA6C04E11F70,
    };
