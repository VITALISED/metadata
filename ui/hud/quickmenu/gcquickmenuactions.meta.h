 ...
 */
class cGcQuickMenuActions : cTkMetaData::Registrar<cGcQuickMenuActions>, cTkMetaDataXML::Registrar<cGcQuickMenuActions>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x5EEC6F79915C67C2,
    };
    enum
    {
        mu64TemplateHash = 0xD0B9100ACFDEC9E1,
    };
