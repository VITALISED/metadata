 ...
 * @class cGcStoryPage
 */
class cGcStoryPage : cTkMetaData::Registrar<cGcStoryPage>, cTkMetaDataXML::Registrar<cGcStoryPage>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xDA4CC10DF6E92F8C,
    };
    enum
    {
        mu64TemplateHash = 0xE8EF7AE92F0F264,
    };
