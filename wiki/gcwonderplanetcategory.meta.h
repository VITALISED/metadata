 ...
 */
class cGcWonderPlanetCategory : cTkMetaData::Registrar<cGcWonderPlanetCategory>, cTkMetaDataXML::Registrar<cGcWonderPlanetCategory>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x1496B0F5A0E7C1DE,
    };
    enum
    {
        mu64TemplateHash = 0x974FA15CCF1DC507,
    };
