 ...
 */
class cGcWikiCategory : cTkMetaData::Registrar<cGcWikiCategory>, cTkMetaDataXML::Registrar<cGcWikiCategory>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xBCA6917366A88ADB,
    };
    enum
    {
        mu64TemplateHash = 0xFFE1F2575FBC1177,
    };
