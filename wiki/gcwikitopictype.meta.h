 ...
 */
class cGcWikiTopicType : cTkMetaData::Registrar<cGcWikiTopicType>, cTkMetaDataXML::Registrar<cGcWikiTopicType>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x72439AF10F4C849F,
    };
    enum
    {
        mu64TemplateHash = 0x89F7B9EF1A67D94F,
    };
