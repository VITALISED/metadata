 ...
 */
class cGcWonderWeirdBasePartCategory : cTkMetaData::Registrar<cGcWonderWeirdBasePartCategory>, cTkMetaDataXML::Registrar<cGcWonderWeirdBasePartCategory>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xBF7B60D4CA07A9C0,
    };
    enum
    {
        mu64TemplateHash = 0xC4FD35234E48565C,
    };
