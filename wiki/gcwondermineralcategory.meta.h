 ...
 */
class cGcWonderMineralCategory : cTkMetaData::Registrar<cGcWonderMineralCategory>, cTkMetaDataXML::Registrar<cGcWonderMineralCategory>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x9B7B2957FC905892,
    };
    enum
    {
        mu64TemplateHash = 0xBB5B13115C4843E7,
    };
