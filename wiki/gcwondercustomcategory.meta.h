 ...
 */
class cGcWonderCustomCategory : cTkMetaData::Registrar<cGcWonderCustomCategory>, cTkMetaDataXML::Registrar<cGcWonderCustomCategory>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x3ACABCA885CFF7F2,
    };
    enum
    {
        mu64TemplateHash = 0xB2A2231AC6C1C0E0,
    };
