/**
 * @file gcclothcollisionbone.meta.h
 ...
 */
class cGcClothCollisionBone : cTkMetaData::Registrar<cGcClothCollisionBone>, cTkMetaDataXML::Registrar<cGcClothCollisionBone>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x3183C2CA4E0D9600,
    };
    enum
    {
        mu64TemplateHash = 0x1DC689F860E9E48F,
    };
