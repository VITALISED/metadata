 ...
 */
class cGcAdvancedTweaks : cTkMetaData::Registrar<cGcAdvancedTweaks>, cTkMetaDataXML::Registrar<cGcAdvancedTweaks>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x1C1691C0F8971C4A,
    };
    enum
    {
        mu64TemplateHash = 0x6E9D7EAB573C6CD6,
    };
