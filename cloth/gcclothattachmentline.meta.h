/**
 * @file gcclothattachmentline.meta.h
 ...
 */
class cGcClothAttachmentLine : cTkMetaData::Registrar<cGcClothAttachmentLine>, cTkMetaDataXML::Registrar<cGcClothAttachmentLine>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x44CED54C76C8DDA0,
    };
    enum
    {
        mu64TemplateHash = 0x2639E8BCA820BC3C,
    };
