 ...
 */
class cGcExperienceDebugTriggerActionTypes : cTkMetaData::Registrar<cGcExperienceDebugTriggerActionTypes>, cTkMetaDataXML::Registrar<cGcExperienceDebugTriggerActionTypes>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x902E6B8A4F1B75A6,
    };
    enum
    {
        mu64TemplateHash = 0xE55FAD85F8721A06,
    };
