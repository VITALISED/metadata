 ...
 * @class cTkLanguages
 */
class cTkLanguages : cTkMetaData::Registrar<cTkLanguages>, cTkMetaDataXML::Registrar<cTkLanguages>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xEA37791FF01A5AF4,
    };
    enum
    {
        mu64TemplateHash = 0x370D5A3B36E0E0F1,
    };
