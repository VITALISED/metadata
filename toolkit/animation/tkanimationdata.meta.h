 ...
 */
class cTkAnimationData : cTkMetaData::Registrar<cTkAnimationData>, cTkMetaDataXML::Registrar<cTkAnimationData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x3A0F3C26A4978A6F,
    };
    enum
    {
        mu64TemplateHash = 0x2B3F7ACFE888523E,
    };
