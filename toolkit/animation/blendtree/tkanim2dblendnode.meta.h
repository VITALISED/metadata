 ...
 */
class cTkAnim2dBlendNode : cTkMetaData::Registrar<cTkAnim2dBlendNode>, cTkMetaDataXML::Registrar<cTkAnim2dBlendNode>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xB08E12209E446AC4,
    };
    enum
    {
        mu64TemplateHash = 0xFF4AD3EEDA81AD59,
    };
