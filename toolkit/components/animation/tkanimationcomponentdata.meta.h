 ...
 */
class cTkAnimationComponentData : cTkMetaData::Registrar<cTkAnimationComponentData>, cTkMetaDataXML::Registrar<cTkAnimationComponentData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x379CFCF1CE84CBAA,
    };
    enum
    {
        mu64TemplateHash = 0xB5263393C2F176F4,
    };
