 ...
 */
class cTkPhysicsComponentData : cTkMetaData::Registrar<cTkPhysicsComponentData>, cTkMetaDataXML::Registrar<cTkPhysicsComponentData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xC58660803669C46F,
    };
    enum
    {
        mu64TemplateHash = 0x25CD3FFA8E448F4E,
    };
