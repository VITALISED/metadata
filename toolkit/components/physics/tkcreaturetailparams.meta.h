 ...
 */
class cTkCreatureTailParams : cTkMetaData::Registrar<cTkCreatureTailParams>, cTkMetaDataXML::Registrar<cTkCreatureTailParams>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xF5A68FEB65BA7107,
    };
    enum
    {
        mu64TemplateHash = 0x4EBCA4EEA1161646,
    };
