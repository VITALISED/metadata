/**
 * @file tkenginesettingsmapping.meta.h
 ...
 */
class cTkEngineSettingsMapping : cTkMetaData::Registrar<cTkEngineSettingsMapping>, cTkMetaDataXML::Registrar<cTkEngineSettingsMapping>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xC02F1D19584B44D,
    };
    enum
    {
        mu64TemplateHash = 0x32F9FD324E2BDA4C,
    };
