 ...
 */
class cTkEngineSettingTypes : cTkMetaData::Registrar<cTkEngineSettingTypes>, cTkMetaDataXML::Registrar<cTkEngineSettingTypes>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x943946549DEC2216,
    };
    enum
    {
        mu64TemplateHash = 0x644B852D83365033,
    };
