 ...
 */
class cTkLODSettingsData : cTkMetaData::Registrar<cTkLODSettingsData>, cTkMetaDataXML::Registrar<cTkLODSettingsData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xA0C253D5A5EF8A51,
    };
    enum
    {
        mu64TemplateHash = 0x4C8D2C5D711DF5C7,
    };
