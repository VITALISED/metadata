 ...
 */
class cTkGraphicsDetailTypes : cTkMetaData::Registrar<cTkGraphicsDetailTypes>, cTkMetaDataXML::Registrar<cTkGraphicsDetailTypes>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xAACA1A6A0194D948,
    };
    enum
    {
        mu64TemplateHash = 0x4EF1F56CF5CA5B73,
    };
