 ...
 */
class cTkMaterialShaderMillData : cTkMetaData::Registrar<cTkMaterialShaderMillData>, cTkMetaDataXML::Registrar<cTkMaterialShaderMillData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xE5F4152C8F8FC861,
    };
    enum
    {
        mu64TemplateHash = 0xD94EC79A8F14C379,
    };
