 ...
 */
class cTkMaterialFlags : cTkMetaData::Registrar<cTkMaterialFlags>, cTkMetaDataXML::Registrar<cTkMaterialFlags>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x71610F70BA400437,
    };
    enum
    {
        mu64TemplateHash = 0xEA132F026E55C047,
    };
