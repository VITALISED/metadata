 ...
 */
class cTkMaterialSampler : cTkMetaData::Registrar<cTkMaterialSampler>, cTkMetaDataXML::Registrar<cTkMaterialSampler>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x330286CE11647D4C,
    };
    enum
    {
        mu64TemplateHash = 0xB1F00BB1F804178A,
    };
