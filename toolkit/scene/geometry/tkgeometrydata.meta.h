 ...
 */
class cTkGeometryData : cTkMetaData::Registrar<cTkGeometryData>, cTkMetaDataXML::Registrar<cTkGeometryData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xA74EA06001E7577E,
    };
    enum
    {
        mu64TemplateHash = 0x3705D946A3B218D4,
    };
