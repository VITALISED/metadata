 ...
 * @class cTkGlobals
 */
class cTkGlobals : cTkMetaData::Registrar<cTkGlobals>, cTkMetaDataXML::Registrar<cTkGlobals>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xB62E6456DFE47836,
    };
    enum
    {
        mu64TemplateHash = 0x91DC0B006B334CE8,
    };
