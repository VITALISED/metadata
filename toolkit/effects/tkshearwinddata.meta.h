 ...
 */
class cTkShearWindData : cTkMetaData::Registrar<cTkShearWindData>, cTkMetaDataXML::Registrar<cTkShearWindData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xB9B8ADD8C9FFC2D8,
    };
    enum
    {
        mu64TemplateHash = 0xC462D4F8119851CF,
    };
