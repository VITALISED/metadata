 ...
 */
class cTkNGuiGraphicStyle : cTkMetaData::Registrar<cTkNGuiGraphicStyle>, cTkMetaDataXML::Registrar<cTkNGuiGraphicStyle>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xB70875CDF93EECEC,
    };
    enum
    {
        mu64TemplateHash = 0x14961F4B4436B554,
    };
