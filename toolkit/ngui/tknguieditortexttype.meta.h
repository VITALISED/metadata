 ...
 */
class cTKNGuiEditorTextType : cTkMetaData::Registrar<cTKNGuiEditorTextType>, cTkMetaDataXML::Registrar<cTKNGuiEditorTextType>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x4780AB6325CE84C6,
    };
    enum
    {
        mu64TemplateHash = 0xCE328FD208CBB692,
    };
