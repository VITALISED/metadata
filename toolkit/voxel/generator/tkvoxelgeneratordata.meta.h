 ...
 */
class cTkVoxelGeneratorData : cTkMetaData::Registrar<cTkVoxelGeneratorData>, cTkMetaDataXML::Registrar<cTkVoxelGeneratorData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x7A347325F1154095,
    };
    enum
    {
        mu64TemplateHash = 0x3541FEC673F2CB77,
    };
