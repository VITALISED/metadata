 ...
 */
class cTkNoiseLayerData : cTkMetaData::Registrar<cTkNoiseLayerData>, cTkMetaDataXML::Registrar<cTkNoiseLayerData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x474596B01166F6A6,
    };
    enum
    {
        mu64TemplateHash = 0xC6E7F5301C2A5B2A,
    };
