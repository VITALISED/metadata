 ...
 */
class cTkNoiseFeatureData : cTkMetaData::Registrar<cTkNoiseFeatureData>, cTkMetaDataXML::Registrar<cTkNoiseFeatureData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xBC975A8E0D580FFA,
    };
    enum
    {
        mu64TemplateHash = 0x11FD8C247496B7E8,
    };
