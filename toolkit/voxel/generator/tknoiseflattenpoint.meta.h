 ...
 */
class cTkNoiseFlattenPoint : cTkMetaData::Registrar<cTkNoiseFlattenPoint>, cTkMetaDataXML::Registrar<cTkNoiseFlattenPoint>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xCE87D0159308C03A,
    };
    enum
    {
        mu64TemplateHash = 0xCD402697FFDFC91B,
    };
