 ...
 */
class cTkGridLayersEnum : cTkMetaData::Registrar<cTkGridLayersEnum>, cTkMetaDataXML::Registrar<cTkGridLayersEnum>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xFEF6F10412C7B60,
    };
    enum
    {
        mu64TemplateHash = 0xB9F17954D3E62F66,
    };
