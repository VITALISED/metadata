 ...
 */
class cTkNoiseUberLayerData : cTkMetaData::Registrar<cTkNoiseUberLayerData>, cTkMetaDataXML::Registrar<cTkNoiseUberLayerData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x174C8C3DB33CE268,
    };
    enum
    {
        mu64TemplateHash = 0x3F104057D08F304F,
    };
