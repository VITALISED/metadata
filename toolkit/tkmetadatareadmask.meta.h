/**
 * @file tkmetadatareadmask.meta.h
 ...
 */
enum eMetadataReadMask : uint32_t
{
 ...
 */
class cTkMetadataReadMask : cTkMetaData::Registrar<cTkMetadataReadMask>, cTkMetaDataXML::Registrar<cTkMetadataReadMask>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x76BB9C78D7AE1C6B,
    };
    enum
    {
        mu64TemplateHash = 0xE5E072016B296CBC,
    };
