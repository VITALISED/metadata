/**
 * @file tkchordpathmapping.meta.h
 ...
 */
class cTkChordPathMapping : cTkMetaData::Registrar<cTkChordPathMapping>, cTkMetaDataXML::Registrar<cTkChordPathMapping>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xA012CD9DA9418E41,
    };
    enum
    {
        mu64TemplateHash = 0xBF2A55B37578B2B0,
    };
