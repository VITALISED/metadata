 ...
 */
class cTkAxisPathMapping : cTkMetaData::Registrar<cTkAxisPathMapping>, cTkMetaDataXML::Registrar<cTkAxisPathMapping>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x19C4AA7DA3B42958,
    };
    enum
    {
        mu64TemplateHash = 0x60587FED618E0B51,
    };
