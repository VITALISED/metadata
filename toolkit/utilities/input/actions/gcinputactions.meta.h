 ...
 */
class cGcInputActions : cTkMetaData::Registrar<cGcInputActions>, cTkMetaDataXML::Registrar<cGcInputActions>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xB3E8C8CD4B9DB0B1,
    };
    enum
    {
        mu64TemplateHash = 0x85D5C880F749EB2D,
    };
