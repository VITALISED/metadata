 ...
 */
class cGcTestMetadata : cTkMetaData::Registrar<cGcTestMetadata>, cTkMetaDataXML::Registrar<cGcTestMetadata>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xCE965FAFD6BBF99E,
    };
    enum
    {
        mu64TemplateHash = 0x73F3D69C8298DC6B,
    };
