 ...
 */
class cGcResourceElement : cTkMetaData::Registrar<cGcResourceElement>, cTkMetaDataXML::Registrar<cGcResourceElement>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x91CAC70AC2792E2A,
    };
    enum
    {
        mu64TemplateHash = 0x1F488BEDB7326A29,
    };
