 ...
 */
class cGcCameraFollowSettings : cTkMetaData::Registrar<cGcCameraFollowSettings>, cTkMetaDataXML::Registrar<cGcCameraFollowSettings>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x200FDA306DC86654,
    };
    enum
    {
        mu64TemplateHash = 0xDF33D9C6EF3F5AF1,
    };
