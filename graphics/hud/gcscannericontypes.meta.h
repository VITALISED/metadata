/**
 * @file gcscannericontypes.meta.h
 ...
 */
class cGcScannerIconTypes : cTkMetaData::Registrar<cGcScannerIconTypes>, cTkMetaDataXML::Registrar<cGcScannerIconTypes>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x8A4027FC041677F0,
    };
    enum
    {
        mu64TemplateHash = 0xDF9C8B4D08CC8914,
    };
