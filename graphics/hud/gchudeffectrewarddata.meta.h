/**
 * @file gchudeffectrewarddata.meta.h
 ...
 */
class cGcHUDEffectRewardData : cTkMetaData::Registrar<cGcHUDEffectRewardData>, cTkMetaDataXML::Registrar<cGcHUDEffectRewardData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x4453C3D28B780FD8,
    };
    enum
    {
        mu64TemplateHash = 0xA1292A1ED2EC32C9,
    };
