 ...
 */
class cGcScannerIcon : cTkMetaData::Registrar<cGcScannerIcon>, cTkMetaDataXML::Registrar<cGcScannerIcon>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x85905E340468CC13,
    };
    enum
    {
        mu64TemplateHash = 0xBFF25FB08364A24A,
    };
