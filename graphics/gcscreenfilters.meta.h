 ...
 */
class cGcScreenFilters : cTkMetaData::Registrar<cGcScreenFilters>, cTkMetaDataXML::Registrar<cGcScreenFilters>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xE50E9B26CC742B3D,
    };
    enum
    {
        mu64TemplateHash = 0x131CD98CFBBC51F,
    };
