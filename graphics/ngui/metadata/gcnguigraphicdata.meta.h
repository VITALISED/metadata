 ...
 */
class cGcNGuiGraphicData : cTkMetaData::Registrar<cGcNGuiGraphicData>, cTkMetaDataXML::Registrar<cGcNGuiGraphicData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x264B878043DA20B3,
    };
    enum
    {
        mu64TemplateHash = 0xFA260C4B6F9A60E0,
    };
