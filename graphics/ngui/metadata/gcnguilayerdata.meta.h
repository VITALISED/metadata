 ...
 */
class cGcNGuiLayerData : cTkMetaData::Registrar<cGcNGuiLayerData>, cTkMetaDataXML::Registrar<cGcNGuiLayerData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x585832A31F4C2EA1,
    };
    enum
    {
        mu64TemplateHash = 0x73FAEAF445FBDC01,
    };
