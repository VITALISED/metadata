 ...
 */
class cGcHUDManagerData : cTkMetaData::Registrar<cGcHUDManagerData>, cTkMetaDataXML::Registrar<cGcHUDManagerData>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x756972574B9CCB08,
    };
    enum
    {
        mu64TemplateHash = 0x205BFEB3B8061079,
    };
