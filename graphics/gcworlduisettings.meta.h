 ...
 */
class cGcWorldUISettings : cTkMetaData::Registrar<cGcWorldUISettings>, cTkMetaDataXML::Registrar<cGcWorldUISettings>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x1805828080FC646E,
    };
    enum
    {
        mu64TemplateHash = 0x4913DD4F5BD20BEF,
    };
