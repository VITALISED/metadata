 ...
 */
class cGcJourneyMedal : cTkMetaData::Registrar<cGcJourneyMedal>, cTkMetaDataXML::Registrar<cGcJourneyMedal>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x33CAC73016241300,
    };
    enum
    {
        mu64TemplateHash = 0x2A90662F35B374DF,
    };
