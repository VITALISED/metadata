 ...
 */
class cGcInputBinding : cTkMetaData::Registrar<cGcInputBinding>, cTkMetaDataXML::Registrar<cGcInputBinding>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x4A8D0B35C3429A12,
    };
    enum
    {
        mu64TemplateHash = 0x3A6A47E184830B13,
    };
