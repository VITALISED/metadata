 ...
 */
class cGcAudioWwiseRTPCs : cTkMetaData::Registrar<cGcAudioWwiseRTPCs>, cTkMetaDataXML::Registrar<cGcAudioWwiseRTPCs>
{
  public:
    enum
    {
        mu64ClassNameHash = 0x92D4879C17049BD7,
    };
    enum
    {
        mu64TemplateHash = 0x2BFA17ACBA2A7F13,
    };
