 ...
 */
class cGcByteBeatSong : cTkMetaData::Registrar<cGcByteBeatSong>, cTkMetaDataXML::Registrar<cGcByteBeatSong>
{
  public:
    enum
    {
        mu64ClassNameHash = 0xDC95ACD037A3B77,
    };
    enum
    {
        mu64TemplateHash = 0x7A1695EC46335BC8,
    };
